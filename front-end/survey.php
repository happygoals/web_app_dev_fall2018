...
?>
	...
	<div class="container-fluid text-center">
		<div class="row row-eq-height" style="padding-top: 70px">
			...
			<div class="col-sm-1 sidebg">
			</div>
			<div class="col-sm-8 text-left">
				<form  method="post" id="submitSurvey" name="submitSurvey" onsubmit="return validate();">
					...
					<div id="question15.1" name="question15.1" style="display: none">
						<h6>Why not?</h6>
						<textarea id="question15.1.0" cols="75" name="Why7" rows="5"></textarea><br><br>
					</div>
					<!-- Question 15 End -->
					<!-- Question 16 Start -->
					...
					<div>
						...
						<label style="width:6%">Email:</label><input id="email" name="email" type="email"><br>
