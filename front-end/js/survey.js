...
function validate() {
	...
	if(isOneChecked(document.getElementById('question1')) == false){
		alert("You must select an answer for question1!");
		return false;
	}
	else {
		if(document.getElementById('yes1').checked == true){
			if(isOneChecked(document.getElementById('question1.2')) == false){
	...
	if(isOneChecked(document.getElementById('question2')) == false){
		alert("You must select an answer for question2!");
		return false;
	}
	else {
		if(document.getElementById('yes2').checked == true){
			if(isOneChecked(document.getElementById('question2.2')) == false){
	...
	// Checks all Question3 inputs
		if(isOneChecked(document.getElementById('question3')) == false){
