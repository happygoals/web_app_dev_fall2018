<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        '$question15','$question15_1','$question16','$name','$email');",
                ...
                $connection->real_escape_string($_POST['opt']),
                $connection->real_escape_string($_POST['opt2']),
                $connection->real_escape_string($_POST['opt3']),
                $connection->real_escape_string($_POST['why']),
                $connection->real_escape_string($_POST['op3.2.0']),
                $connection->real_escape_string($_POST['opt4']),
                $connection->real_escape_string($_POST['why2']),
                $connection->real_escape_string($_POST['op4.2.0']),
                $connection->real_escape_string($_POST['opt5']),
                $connection->real_escape_string($_POST['opt6']),
                $connection->real_escape_string($_POST['opt7']),
                $connection->real_escape_string($_POST['opt8']),
                $connection->real_escape_string($_POST['op9.0.0']),
                $connection->real_escape_string($_POST['Why3']),
                $connection->real_escape_string($_POST['op10.0.0']),
                $connection->real_escape_string($_POST['Why4']),
                $connection->real_escape_string($_POST['op11']),
                $connection->real_escape_string($_POST['Why5']),
                $connection->real_escape_string($_POST['op12']),
                $connection->real_escape_string($_POST['Why6']),
                $connection->real_escape_string($_POST['']),   //question 13
                $connection->real_escape_string($_POST['']),   //question 13_1
                $connection->real_escape_string($_POST['']),   //question 14
                $connection->real_escape_string($_POST['']),   //question 14_1
                $connection->real_escape_string($_POST['opt15']),
                $connection->real_escape_string($_POST['Why7']),
                $connection->real_escape_string($_POST['Why8']),
